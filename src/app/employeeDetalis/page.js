                    ...
                    <div className="inner-all">
                      <ul className="list-unstyled">
                        ...
                        <li className="text-center">
                          <h4 className="text-capitalize mt-3 mb-0">
                            Anna Sthesia
                          </h4>
                              ...
                              <ul className="media-list">
                                <li className="media mt-4">
                                  ...
                                  <div className="media-body">
                                    {" "}
                                    Holley Corby: I must explain to you how all
                            ...
                            <div className="media-body">
                              ...
                              <ul className="media-list">
                                <li className="media mt-4">
                                  ...
                                  <div className="media-body">
                                    {" "}
                                    Art Langner: master-builder of human
                          ...
                          <table className="table card-table table-vcenter border text-nowrap">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>12 June 2018</td>
                                <td>
                                  <span className="status-icon bg-danger" /> On
                                  going
                                </td>
                                <td>$45,087</td>
                              </tr>
